...
begin
    ...
    if row_num = 0 then
        ...
        REPLACE INTO `blog_article`(`id`, `url`, `title`, `description`, `image`, `content`, `content_md`, `category_id`, `create_time`, `update_time`, `is_top`, `is_comment`, `is_original`, `source_url`, `visits`, `status`) VALUES ('1', 'hello-world', 'hello world!', '你好，世界', null, '<h1><a id=\"Hello_World_0\"></a>Hello World</h1>\n<p>你好，世界。<br />\n欢迎使用本博客系统。<br />\n写博客需要坚持，一起努力加油吧！</p>\n', '# Hello World\n你好，世界。\n欢迎使用本博客系统。\n写博客需要坚持，一起努力加油吧！', '1',NOW(), NOW(), '0', '1', '1', null, '0', '1'),
                                          ('2', 'about', '关于我', '关于我', null, '<p style=\"text-align: center;\">\r\n	<span style=\"font-size: 14pt;\">欢迎来到<strong>我的个人博客</strong></span>\r\n</p>\r\n<div class=\"alert alert-danger\">我是一个好人。<br>我真的是一个好人哦！\r\n</div>\r\n<div class=\"alert alert-success\">这是个自定义文章示例界面<br>内容完全自定义<br>嘿嘿嘿~</div>\r\n<div class=\"alert alert-danger\">博客项目在<a href=\"https://github.com/hinz/blog\">这里https://github.com/hinz/blog</a><br>参考的博客主题在<a href=\"https://github.com/ZEROKISEKI/hexo-theme-gal\">这里https://github.com/ZEROKISEKI/hexo-theme-gal</a><br>参考网站在<a href=\"https://www.mmgal.com/\">这里https://www.mmgal.com/</a></div>', '<p style=\"text-align: center;\">\r\n	<span style=\"font-size: 14pt;\">欢迎来到<strong>我的个人博客</strong></span>\r\n</p>\r\n<div class=\"alert alert-danger\">我是一个好人。<br>我真的是一个好人哦！\r\n</div>\r\n<div class=\"alert alert-success\">这是个自定义文章示例界面<br>内容完全自定义<br>嘿嘿嘿~</div>\r\n<div class=\"alert alert-danger\">博客项目在<a href=\"https://github.com/hinz/blog\">这里https://github.com/hinz/blog</a><br>参考的博客主题在<a href=\"https://github.com/ZEROKISEKI/hexo-theme-gal\">这里https://github.com/ZEROKISEKI/hexo-theme-gal</a><br>参考网站在<a href=\"https://www.mmgal.com/\">这里https://www.mmgal.com/</a></div>', null, NOW(),NOW(), '0', '1', '1', null, '0', '3');

        REPLACE INTO `blog_comment`(`id`, `article_id`, `author`, `email`, `email_md5`, `user_agent`, `content`, `ip`, `parent_id`, `is_admin`, `create_time`, `status`) VALUES ('1', '1', 'zhouhua', 'hinz@163.com', '2bf0ebee5f19445f2af02908d5c3ab0e', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.67 Safari/537.36', '欢迎！', '127.0.0.1', '0', '0', NOW(), '1');

        REPLACE INTO `blog_category` (`id`, `name`, `url`) VALUES ('1', '未分类', 'default');

        REPLACE INTO `blog_link`(`id`, `name`, `url`, `type`) VALUES ('1', '周华个人博客', 'https://www.hinz.com', '1'),
                                                              ('2', 'GitHub', 'https://hinz.github,io', '2');
