package com.hinz.blog.common.aspect;
...
import com.hinz.blog.service.LogService;
...
public class BlogLogAspect {
    ...
    @Around("execution(public * com.hinz.blog.controller.front..*.*(..)) && !@annotation(org.springframework.web.bind.annotation.ModelAttribute)")
